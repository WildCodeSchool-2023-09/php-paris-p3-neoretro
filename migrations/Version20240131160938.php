 ...
 */
final class Version20240131160938 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, game_id INT DEFAULT NULL, first_prize_id INT DEFAULT NULL, second_prize_id INT DEFAULT NULL, third_prize_id INT DEFAULT NULL, label VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, is_visible TINYINT(1) NOT NULL, slug VARCHAR(255) NOT NULL, INDEX IDX_3BAE0AA7E48FD905 (game_id), INDEX IDX_3BAE0AA7FFC004F (first_prize_id), INDEX IDX_3BAE0AA788F06D71 (second_prize_id), INDEX IDX_3BAE0AA7CE1C36D1 (third_prize_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE prize (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, value INT NOT NULL, quantity INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, firstname VARCHAR(100) NOT NULL, lastname VARCHAR(100) NOT NULL, token INT DEFAULT NULL, phonenumber VARCHAR(16) DEFAULT NULL, adress VARCHAR(100) DEFAULT NULL, city VARCHAR(30) DEFAULT NULL, zipcode VARCHAR(5) DEFAULT NULL, email VARCHAR(40) NOT NULL, experience INT DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE event ADD CONSTRAINT FK_3BAE0AA7FFC004F FOREIGN KEY (first_prize_id) REFERENCES prize (id)');
        $this->addSql('ALTER TABLE event ADD CONSTRAINT FK_3BAE0AA788F06D71 FOREIGN KEY (second_prize_id) REFERENCES prize (id)');
        $this->addSql('ALTER TABLE event ADD CONSTRAINT FK_3BAE0AA7CE1C36D1 FOREIGN KEY (third_prize_id) REFERENCES prize (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event DROP FOREIGN KEY FK_3BAE0AA7FFC004F');
        $this->addSql('ALTER TABLE event DROP FOREIGN KEY FK_3BAE0AA788F06D71');
        $this->addSql('ALTER TABLE event DROP FOREIGN KEY FK_3BAE0AA7CE1C36D1');
